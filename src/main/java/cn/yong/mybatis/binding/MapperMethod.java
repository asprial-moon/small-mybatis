        ...
        public Object convertArgsToSqlCommandParam(Object[] args) {
            ...
            if (args == null || paramCount == 0) {
                ...
                for (Map.Entry<Integer, String> entry : params.entrySet()) {
                    ...
                    // issue #71, add param names on param1, param2...but ensure backward compatibility
                    final String genericParamName = "param" + (i + 1);
                    if (!param.containsKey(genericParamName)) {
                        /**
                         * 2.再加一个#{param1},#{param2}...参数
                         * 你可以传递多个参数给一个映射器方法。如果你这样做了，
                         * 默认情况下他们将会以它们再参数列表中的位置来命名，比如:#{param1},#{param2}等。
    ...
    public static class ParamMap<V> extends HashMap<String, V> {
        ...
        public V get(Object key) {
            if (!super.containsKey(key)) {
                throw new RuntimeException("Parameter '" + key + "' not found. Available parameter are " + keySet());
            }
